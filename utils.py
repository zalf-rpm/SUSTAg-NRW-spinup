...
def concatenate_files():    
    ...
    base_dir = "Z:/projects/sustag/spinup-version/out_paper1/16-10-18/tagged/splitted/15"
    ...
    for dirName, subdirList, fileList in os.walk(base_dir):
        ...
        if "aggregated" in dirName:
            for f_type in ["_year", "_crop"]:
                ...
                print("concatenating data frames...")
                merged_df = pd.concat(dframes)
                merged_df.to_csv("C:/Users/stella/Documents/GitHub/SUSTAg-NRW-spinup/out/" + id_sim + f_type + ".csv")
...
def aggregate_results_paper1():
    ...
    #base_dir = "Z:/projects/sustag/spinup-version/out_paper1/16-10-18/tagged/splitted/4/"
    for dirName, subdirList, fileList in os.walk(base_dir):
        print('Found directory: %s' % dirName)
        if "aggregated" in dirName:
