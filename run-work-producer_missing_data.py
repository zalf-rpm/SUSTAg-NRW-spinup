...
PATHS = {
    "stella": {
        ...
        "local-monica-server": "tcp://localhost:6666"
    },
    "berg": {
        "INCLUDE_FILE_BASE_PATH": "C:/Users/stella/Documents/GitHub",
        "path-to-data-dir": "z:/data/",
        "local-monica-server": "tcp://10.10.26.34:6666"
    }
}
...
_timeframes = {
    "continuous": {
        ...
        "start-recording-out": 1971,
        "cluster-path-to-climate": ["/archiv-daten/md/data/climate/isimip/csvs/IPSL-CM5A-LR/historical/earth/", "/archiv-daten/md/data/climate/isimip/csvs/IPSL-CM5A-LR/rcp2p6/germany-nrw/"], #base + rcp 2.6
        "local-path-to-climate": ["d:/climate/isimip/csvs/IPSL-CM5A-LR/historical/earth/", "d:/climate/isimip/csvs/IPSL-CM5A-LR/rcp2p6/germany-nrw/"] #base + rcp 2.6
    }
}
